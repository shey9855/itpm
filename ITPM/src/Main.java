...
public class Main extends JFrame {
	...
	public Main() {
		...
		Image imgW = new ImageIcon(this.getClass().getResource("calendar.png")).getImage();
		btnNewButton.setIcon(new ImageIcon(imgW));
		btnNewButton.setFont(new Font("Ink Free", Font.BOLD, 14));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Add_working_Days add_working_Days= new Add_working_Days();
				add_working_Days.show();
		...
		Image imgS = new ImageIcon(this.getClass().getResource("sub.png")).getImage();
		...
		Image imgSt = new ImageIcon(this.getClass().getResource("stat.png")).getImage();
		...
		Image imgL = new ImageIcon(this.getClass().getResource("lec.png")).getImage();
		...
		Image imgT = new ImageIcon(this.getClass().getResource("tag.png")).getImage();
		...
		Image imgM = new ImageIcon(this.getClass().getResource("session.png")).getImage();
		...
		Image imgSg = new ImageIcon(this.getClass().getResource("student.png")).getImage();
		...
		Image imgLo = new ImageIcon(this.getClass().getResource("location.png")).getImage();
		...
		Image imgGt = new ImageIcon(this.getClass().getResource("time.png")).getImage();
