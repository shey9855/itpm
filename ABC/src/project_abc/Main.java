...
public class Main extends JFrame {
	...
	public Main() {
		...
		Image imgW = new ImageIcon(this.getClass().getResource("/project_abc/calendar.png")).getImage();
		...
		Image imgS = new ImageIcon(this.getClass().getResource("/project_abc/sub.png")).getImage();
		...
		Image imgSt = new ImageIcon(this.getClass().getResource("/project_abc/stat.png")).getImage();
		...
		Image imgL = new ImageIcon(this.getClass().getResource("/project_abc/lec.png")).getImage();
		...
		Image imgT = new ImageIcon(this.getClass().getResource("/project_abc/tag.png")).getImage();
		...
		Image imgM = new ImageIcon(this.getClass().getResource("/project_abc/session.png")).getImage();
		...
		Image imgSg = new ImageIcon(this.getClass().getResource("/project_abc/student.png")).getImage();
		...
		Image imgLo = new ImageIcon(this.getClass().getResource("/project_abc/location.png")).getImage();
		...
		Image imgGt = new ImageIcon(this.getClass().getResource("/project_abc/time.png")).getImage();
