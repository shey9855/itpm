...
public class Main extends JFrame {
	...
	public Main() {
		...
		Image imgW = new ImageIcon(this.getClass().getResource("/abc_institute/calendar.png")).getImage();
		btnNewButton.setIcon(new ImageIcon(imgW));
		btnNewButton.setFont(new Font("Ink Free", Font.BOLD, 14));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				Add_working_Days main = new Add_working_Days();
				main.show();
		...
		Image imgS = new ImageIcon(this.getClass().getResource("/abc_institute/sub.png")).getImage();
		...
		Image imgSt = new ImageIcon(this.getClass().getResource("/abc_institute/stat.png")).getImage();
		...
		Image imgL = new ImageIcon(this.getClass().getResource("/abc_institute/lec.png")).getImage();
		...
		Image imgT = new ImageIcon(this.getClass().getResource("/abc_institute/tag.png")).getImage();
		...
		Image imgM = new ImageIcon(this.getClass().getResource("/abc_institute/session.png")).getImage();
		...
		btnNewButton_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				grp_student grp_student = new grp_student();
				grp_student.show();
		...
		Image imgSg = new ImageIcon(this.getClass().getResource("/abc_institute/student.png")).getImage();
		...
		Image imgLo = new ImageIcon(this.getClass().getResource("/abc_institute/location.png")).getImage();
		...
		Image imgGt = new ImageIcon(this.getClass().getResource("/abc_institute/time.png")).getImage();
