...
public class Subject extends JFrame {
	...
	public Subject() {
		...
		offered_year_required_.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 12));
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                int No_of_evaHours = (int) spinnerEva.getValue();
                    ...
                    if(textFieldName.getText().trim().isEmpty() && textField_1code.getText().trim().isEmpty() && comboBox_offeredyear.getSelectedItem() == "(select)"){
                        subject_name_required.setText("Subject Name is required !"); 
                        subject_code_required_1.setText("Subject Code is required !"); 
                        offered_year_required_.setText("Offered Year is required !");
                    }
                    ...
                    else if(comboBox_offeredyear.getSelectedItem() == "(select)") {
                    	offered_year_required_.setText("Offered Year is required !");}
		...
		JLabel year_required = new JLabel("");
		year_required.setForeground(Color.RED);
		year_required.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 13));
		year_required.setBounds(250, 229, 208, 13);
		panel.add(year_required);
